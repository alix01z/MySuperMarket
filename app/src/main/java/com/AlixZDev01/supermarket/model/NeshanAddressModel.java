...
public class NeshanAddressModel {
    ...
    // 2 constructors for 2 kind of response
    public NeshanAddressModel(String neighbourhood, String address, String municipality_zone, Boolean in_traffic_zone, Boolean in_odd_even_zone, String city, String state) {
    ...
    public NeshanAddressModel(String status, Integer code, String message) {
        this.status = status;
        this.code = code;
